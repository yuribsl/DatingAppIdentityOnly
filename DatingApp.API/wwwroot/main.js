...
module.exports = "<div class=\"row\">\r\n  <table class=\"table\">\r\n    <tr>\r\n      <th style=\"width: 10%\">User Id</th>\r\n      <th style=\"width: 30%\">User Name</th>\r\n      <th style=\"width: 40%\">Active Roles</th>\r\n      <th style=\"width: 20%\"></th>\r\n    </tr>\r\n    <tr *ngFor=\"let user of users\">\r\n      <td>{{user.id}}</td>\r\n      <td>{{user.userName}}</td>\r\n      <td>{{user.roles}}</td>\r\n      <td><button class=\"btn btn-info\" (click)=\"editRolesModal()\">Edit Roles</button></td>\r\n    </tr>\r\n  </table>\r\n</div>\r\n"
...
var UserManagementComponent = /** @class */ (function () {
    ...
    UserManagementComponent.prototype.getUsersWithRoles = function () {
        ...
        this.adminService.getUsersWithRoles()
            .subscribe(function (users) { _this.users = users; }, function (error) { console.log(error); });
    };
    UserManagementComponent.prototype.editRolesModal = function () {
        var initialState = {
            list: [
...
/* harmony import */ var _directives_hasRole_directive__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./directives/hasRole.directive */ "./src/app/directives/hasRole.directive.ts");
/* harmony import */ var _admin_user_management_user_management_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./admin/user-management/user-management.component */ "./src/app/admin/user-management/user-management.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _admin_user_management_user_management_component__WEBPACK_IMPORTED_MODULE_35__["UserManagementComponent"],
...
module.exports = __webpack_require__(/*! C:\Users\yuri_\Documents\Meus Projetos\DatingAppIdentityOnly\DatingApp-SPA\src\main.ts */"./src/main.ts");
